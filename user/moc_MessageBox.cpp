...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MessageBox_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 45, 7)
    ...
    "MessageBox\0sig_show\0\0sig_close\0"
    "slt_desalting\0opacity"
};
...
void MessageBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MessageBox::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MessageBox::sig_show)) {
                *result = 0;
            }
        }
        {
            typedef void (MessageBox::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MessageBox::sig_close)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject MessageBox::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MessageBox.data,
      qt_meta_data_MessageBox,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MessageBox.stringdata))
