...
struct qt_meta_stringdata_LinkC_Label_t {
    QByteArrayData data[3];
    char stringdata[21];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_LinkC_Label_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_LinkC_Label_t qt_meta_stringdata_LinkC_Label = {
    {
QT_MOC_LITERAL(0, 0, 11),
QT_MOC_LITERAL(1, 12, 7),
QT_MOC_LITERAL(2, 20, 0)
    },
    "LinkC_Label\0clicked\0"
};
...
void LinkC_Label::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (LinkC_Label::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LinkC_Label::clicked)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject LinkC_Label::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_LinkC_Label.data,
      qt_meta_data_LinkC_Label,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LinkC_Label.stringdata))
