...
#include "include/qtui/friendslist.h"
...
QT_MOC_LITERAL(3, 20, 8)
    ...
    "FriendItem\0clicked\0\0UserData"
};
...
void FriendItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->clicked((*reinterpret_cast< UserData(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (FriendItem::*_t)(UserData );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FriendItem::clicked)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject FriendItem::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_FriendItem.data,
      qt_meta_data_FriendItem,  qt_static_metacall, 0, 0}
};
...
// SIGNAL 0
void FriendItem::clicked(UserData _t1)
{
...
QT_MOC_LITERAL(4, 29, 11)
    ...
    "FriendsList\0ChatTo\0\0UserData\0ItemClicked"
};
#undef QT_MOC_LITERAL
...
void FriendsList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->ChatTo((*reinterpret_cast< UserData(*)>(_a[1]))); break;
        case 1: _t->ItemClicked((*reinterpret_cast< UserData(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            typedef void (FriendsList::*_t)(UserData );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FriendsList::ChatTo)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject FriendsList::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_FriendsList.data,
      qt_meta_data_FriendsList,  qt_static_metacall, 0, 0}
};
...
// SIGNAL 0
void FriendsList::ChatTo(UserData _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
    QMetaObject::activate(this, &staticMetaObject, 0, _a);
}
